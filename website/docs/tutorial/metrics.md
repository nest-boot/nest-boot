...
Register the `MetricsModule` in your application module:
...
- Exposes a `GET /metrics` endpoint
...
See the full [API documentation](/docs/api/@nest-boot/metrics) for detailed information.
