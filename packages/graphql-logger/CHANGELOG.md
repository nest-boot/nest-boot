...
- Updated @nest-boot/logger to 8.0.5-beta.0

## 8.0.6-beta.0 (2026-09-23)

### 🧱 Updated Dependencies

- Updated @nest-boot/logger to 8.0.4-beta.1

## 8.0.5-beta.0 (2026-09-19)
...
- Updated @nest-boot/logger to 8.0.4-beta.0

## 8.0.4-beta.0 (2026-09-17)

### 🧱 Updated Dependencies

- Updated @nest-boot/graphql to 8.0.0-beta.4
...
- Updated @nest-boot/graphql to 8.0.0-beta.3
- Updated @nest-boot/logger to 8.0.3-beta.0
...
- Updated @nest-boot/logger to 8.0.0-beta.2
...
- Updated @nest-boot/logger to 8.0.0-beta.1
...
- Updated @nest-boot/logger to 7.3.7
...
- Updated @nest-boot/logger to 7.3.5
...
- Updated @nest-boot/logger to 7.3.4

## 7.3.3 (2026-08-28)

### 🧱 Updated Dependencies

- Updated @nest-boot/logger to 7.3.3
...
- Updated @nest-boot/logger to 7.3.2
...
- Updated @nest-boot/logger to 7.3.1
...
- Updated @nest-boot/logger to 7.3.0
...
- Updated @nest-boot/logger to 7.2.1
...
- Updated @nest-boot/logger to 7.2.0
