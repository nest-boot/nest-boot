...
- Updated @nest-boot/staged-upload to 8.0.3-beta.0
...
- Updated @nest-boot/staged-upload to 8.0.2-beta.0
...
## 8.0.3-beta.0 (2026-09-17)

### 🧱 Updated Dependencies

- Updated @nest-boot/graphql to 8.0.0-beta.4

## 8.0.2-beta.0 (2026-09-16)

### 🧱 Updated Dependencies

- Updated @nest-boot/staged-upload to 8.0.1-beta.0
- Updated @nest-boot/storage to 8.0.0-beta.5

## 8.0.1-beta.0 (2026-09-08)
...
- Updated @nest-boot/staged-upload to 8.0.0-beta.5
...
- Updated @nest-boot/staged-upload to 8.0.0-beta.4
