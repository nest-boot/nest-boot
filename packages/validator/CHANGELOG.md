...
- Updated @nest-boot/i18n to 8.0.3-beta.0
...
- Updated @nest-boot/i18n to 8.0.0-beta.2
...
- Updated @nest-boot/i18n to 8.0.0-beta.1
...
- Updated @nest-boot/i18n to 7.3.6
...
- Updated @nest-boot/i18n to 7.3.5
...
- Updated @nest-boot/i18n to 7.3.4

## 7.3.4 (2026-08-28)

### 🩹 Fixes

- **validator:** handle non-string length values ([#301](https://github.com/nest-boot/nest-boot/pull/301))
...
- Updated @nest-boot/i18n to 7.3.3
...
- Updated @nest-boot/i18n to 7.3.2
...
- Updated @nest-boot/i18n to 7.3.1
...
- Updated @nest-boot/i18n to 7.3.0
...
- Updated @nest-boot/i18n to 7.2.1
...
- Updated @nest-boot/i18n to 7.2.0
