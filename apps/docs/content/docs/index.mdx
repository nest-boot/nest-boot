...
| [@nest-boot/graphql-staged-upload](/docs/tutorial/graphql-staged-upload) | GraphQL staged upload mutation       |
...
| [@nest-boot/permission](/docs/tutorial/permission)                       | CASL permission checks               |
